...
export const services = [
    {
        id: "1",
        name: "Send Money",
        icon: icons.electricity, // Keeping the original icon
        iconColor: "#FFD300",
        backgroundColor: "rgba(255, 211, 0, .12)",
        onPress: "sendMoneyScreen"
    },
    {
        id: "2",
        name: "Split Bill",
        icon: icons.internet2, // Keeping the original icon
        iconColor: "#FF981F",
        backgroundColor: "rgba(255, 152, 31, .12)",
        onPress: "splitBillScreen"
    },
    {
        id: "3",
        name: "Pay Bills",
        icon: icons.water, // Keeping the original icon
        iconColor: "#1A96F0",
        backgroundColor: "rgba(26, 150, 240, .12)",
        onPress: "payBillScreen"
    },
    {
        id: "4",
        name: "Bill Reminders",
        icon: icons.wallet2, // Keeping the original icon
        iconColor: "#673AB3",
        backgroundColor: "rgba(103, 58, 179, .12)",
        onPress: "billReminderScreen"
    },
    {
        id: "5",
        name: "Merchant Payments",
        icon: icons.cart, // Keeping the original icon
        iconColor: "#9D28AC",
        backgroundColor: "rgba(157, 40, 172, .12)",
        onPress: "merchantPaymentScreen"
    },
    {
        id: "6",
        name: "Installments",
        icon: icons.installment, // Keeping the original icon
        iconColor: "#FF5726",
        backgroundColor: "rgba(255, 87, 38, .12)",
        onPress: "installmentScreen"
    },
    {
        id: "7",
        name: "Mobile Recharge",
        icon: icons.mobile, // Keeping the original icon
        iconColor: "#00BCD3",
        backgroundColor: "rgba(0, 188, 211, .12)",
        onPress: "mobileRechargeScreen"
    },
];
