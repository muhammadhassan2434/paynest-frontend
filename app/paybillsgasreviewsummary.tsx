...
const PayBillsGasReviewSummary = () => {
  const { colors, dark } = useTheme();
  const { navigate } = useNavigation<Nav>();
  const params = useLocalSearchParams();
  const { userId, token } = useAuth();
  const { bill_provider, consumer_number, customer_name, amount, due_date } =
    params;
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.viewViewContainer}>
            ...
            <View style={{ marginVertical: 12 }}>
              ...
              >
                Pay gas bills safely, conveniently & easily.
              </Text>
              <Text
                style={[
                  styles.subtitle,
...
export default PayBillsGasReviewSummary;
