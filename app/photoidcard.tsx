    ...
    >
      <SafeAreaView style={[styles.area, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.bottomContainer}>
          <Button title="Continue" style={styles.sendBtn} onPress={handleContinue} filled />
        </View>
        <RBSheet
          ref={refRBSheet}
        ...
        >
          ...
          >
            You are about to transfer Rs {amount}. Please confirm if this is correct.
          </Text>

          <Button title="Continue" filled style={styles.requestButton} onPress={handleSheetContinue} />
        </RBSheet>
      </SafeAreaView>
    </KeyboardAvoidingView>
  );
